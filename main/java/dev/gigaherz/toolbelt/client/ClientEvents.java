    ...
    public static class ModBusEvents
    {
        ...
        public static void initKeybinds(RegisterKeyMappingsEvent event)
        {
            event.register(OPEN_TOOL_MENU_KEYBIND =
                    new KeyMapping("key.toolbelt.open", InputConstants.UNKNOWN.getValue(), "key.toolbelt.category"));
            ...
            event.register(OPEN_BELT_SLOT_KEYBIND =
                    new KeyMapping("key.toolbelt.slot", InputConstants.UNKNOWN.getValue(), "key.toolbelt.category"));
        }
